...
// Variables
const rootDomain = "dediwebsx.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "pro"; // Ganti dengan nama workers kalian
const apiKey = "DOJac7cindo_xB1N5Q9tjB3NSbyWl6HEPAiKOr"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "dediwebzxz@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "b4fcd794f838466cbbc9d9502604a"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "083ac8664353e8fe1c02347a065fc"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
